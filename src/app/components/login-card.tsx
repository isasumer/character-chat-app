...
export default function LoginCard() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center justify-center gap-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-xl border border-[var(--border)] p-8"
    >
